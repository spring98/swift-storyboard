...
//  test0502
//
//  Created by spring on 2022/05/03.
//
...
class LocationViewController :UIViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    override func loadView() {
        ...
        override func viewDidLoad() {
            ...
            let url = URL(string: "https://foreverspring98.com/funny_kakaomap.html")
